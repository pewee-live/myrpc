...
public class MessageRecvBusinessTask implements Runnable {
    ...
    MessageRecvBusinessTask(MessageRequest request, MessageResponse response, Map<String, Object> handlerMap, ChannelHandlerContext ctx) {
        this.request = request;
